...
function HeroSection() {
  ...
  return (
    <div id='hero' className='grid grid-cols-1 place-items-end lg:place-items-center lg:grid-cols-5 h-[75vh] section-anchor text-white lg:text-black'>
      ...
      <div className='relative z-49 col-span-2 lg:ml-15 flex flex-col justify-around h-[75vh] lg:h-full items-center py-10 bg-black/40 lg:bg-transparent text-center lg:text-left mx-6 lg:mx-0'>
