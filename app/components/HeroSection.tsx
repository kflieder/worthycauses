...
function HeroSection() {
  ...
  return (
    <div id='hero' className='relative grid grid-cols-1 place-items-center lg:grid-cols-5 section-anchor text-white lg:text-black my-10 mb-0 lg:mb-10'>
      ...
      <div className='relative z-49 col-span-2 xl:ml-10 flex flex-col gap-6 justify-between h-auto xl:h-full items-center py-8 xl:py-15 bg-black/70 lg:bg-transparent text-center lg:text-left mx-4 lg:ml-10 xl:mx-0 my-20 sm:my-30 lg:my-0'>
        <h1 className="text-2xl xl:text-3xl font-bold px-4 leading-10 text-center">Helping individuals and communities</h1>
